...
function chartsLine(){
    try {
        configChartsLine('line', 'Vendas',  [10, 20, -10, 30, 40], [2020, 2021, 2022, 2023, 2024], 'Grafico Anual de valores', '#chart-line');
    } catch (error) {
...
function chartsArea(){
    try {
        configChartsArea('#chart-area', 'area', 'Clientes Cancelados', [10, 90, 50, 10, 5, 80, 45], ['Janeiro', 'Fevereiro', 'Março', 'Abril', 'Maio', 'Junho', 'Julho'], 'clientes Cancelados por periodo');
    } catch (error) {
...
(){
    try {
        configChartsPie('donut', [10,20,40,70], ['Cliente A', 'Cliente B', 'Cliente C', 'Cliente D'], '1.0' ,'Grafico de clientes por Vendas', '#chart-pie');

        configChartsPie('donut', [10 , 20 , 40 , 70 ], ['Cliente Z', 'Cliente Y', 'Cliente X', 'Cliente W'], '1.0' ,'Grafico de clientes por Vendas', '#chart-pie-one');
        
        configChartsPie('donut', [100, 256 , 40 , 70 ], ['Cliente F', 'Cliente G', 'Cliente H', 'Cliente I'], '1.0' ,'Grafico de clientes por Vendas', '#chart-pie-two');
        
        configChartsPie('donut', [ 5, 1, 8 , 9], ['Cliente R', 'Cliente S', 'Cliente T', 'Cliente U'], '1.0' ,'Grafico de clientes por Vendas', '#chart-pie-tree');
...
function chartBars(){
  try {
    configChartsBars( '#chart-bar','bar', ['Cliente A', 'Cliente B', 'Cliente C', 'Cliente D'], [10, 50, 90 ,40], 'Comparação entre clientes' )
  } catch (error) {
